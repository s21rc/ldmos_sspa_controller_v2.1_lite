/*                                                                                             */
/*  Arduino Code (Version 2.1.12) for S21RC LDMOS Controller V1.x. PCB.                        */
...
void loop()
{
    ...
    if (display_page == 2)
    {
        ...
        if ((millis() - lastDiagRequest) >= DiagdelayInMillis)
        {
            ...
            myNex.writeNum("D9.val", calibrationP*1000);
            myNex.writeNum("D0.val", raw_fwd/ref_vdd);
            myNex.writeNum("D2.val", raw_ref/ref_vdd);
            myNex.writeNum("D1.val", power_fwd);
            myNex.writeNum("D3.val", power_ref);
            int ratio_disp = (power_ratio * 10) + 0.5;
            myNex.writeNum("Dx1.val", ratio_disp);
